...
We calculate confusion matrices at three different thresholds to review changes in metrics as thresholds increase/decrease. We will use thresholds: 1. 0.2 (pred_0.2) 2. 0.5 (we will use the base dataset, .pred_class) 3. 0.8 (pred_0.8). xyz
